...
<c:choose>
    ...
    <div id="main_content">
        ...
        <div class="center_content">
            ...
            <div class="center_title_bar">Select Product Picture. </div>

            <div class="prod_box">

                <img src="images/product/no_product.png"  id="blah" width="244" height="260" />
                </br>
                </br>
                <form action ="addProductPicture.jsp" enctype="multipart/form-data" method="POST" >
                    <input type="file" id="imgInp" name="pic" value="Browse" accept="image/jpeg"/><br/>
