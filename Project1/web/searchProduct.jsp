...
<c:choose>
        ...
        <div id="logo"> <img src="images/mainlogo.png" alt="" border="0" width="182" height="85" /><a href="index.jsp"></a> </div>
    </div>
    <div id="main_content">
        <div id="menu_tab">
            <ul class="menu">
        ...
        <!-- end of left content -->
            ...
            <div class="center_title_bar">Search Product</div>

            <div style="margin-top: 50px;">


            <c:choose>
                <c:when test="${param.searchBy == 'name'}">
                 <form method="get" action="searchProduct.jsp">
                    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                    <p2>Search By&emsp;&emsp;&emsp;</p2>
                     <select name="searchBy">
                        <option value="name" selected>Name</option>
                        <option value="lessthan" >Price less than</option>
                        <option value="morethan" >Price more than</option>
                    </select>
                    &emsp;&emsp;&emsp;
                    ...
                    <sql:query dataSource="${snapshot}" var="result4">
                        select * from product where pname='${param.value}'
                    </sql:query>
                    <c:forEach var="product" items="${result4.rows}" varStatus="status">
                        <div class="prod_box">
                            <div class="center_prod_box">
                                <div class="product_title"><a onclick="window.open('detail.jsp?pictureType=product&id=${product.id}','Ratting','width=600,height=600,left=0,top=0,toolbar=0,status=0');">${product.pname}</a></div>
                                ...
                                <div class="prod_price"><!--<span class="reduce">350$</span> --><span class="price">${product.price} $</span></div>
                            </div>
                ...
                <c:when test="${param.searchBy == 'lessthan'}">
                    <form method="get" action="searchProduct.jsp">
                    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                    <p2>Search By&emsp;&emsp;&emsp;</p2>
                    <select name="searchBy">
                    <option value="name" >Name</option>
                    <option value="lessthan" selected>Price less than</option>
                    <option value="morethan" >Price more than</option>
                    </select>
                    ...
                    <sql:query dataSource="${snapshot}" var="result4">
                        select * from product where price < ${param.value}
                    </sql:query>
                    <c:forEach var="product" items="${result4.rows}" varStatus="status">
                        <div class="prod_box">
                            <div class="center_prod_box">
                ...
                <c:when test="${param.searchBy == 'morethan'}">
                    <form method="get" action="searchProduct.jsp">
                    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                    <p2>Search By&emsp;&emsp;&emsp;</p2>
                    <select name="searchBy">
                    <option value="name" >Name</option>
                    <option value="lessthan" >Price less than</option>
                    <option value="morethan" selected>Price more than</option>
                    </select>
