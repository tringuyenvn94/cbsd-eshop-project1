...
<c:choose>
    ...
    <div id="main_content">
        ...
        <div class="center_content">
            ...
            <div class="center_title_bar">Step 2 Select Picture. </div>

            <div class="prod_box">

                <img src="images/user/0.jpg"  id="blah" width="244" height="260" />
                </br>
                </br>
                <form action ="signup_uppicture.jsp" enctype="multipart/form-data" method="POST" runat="server">
