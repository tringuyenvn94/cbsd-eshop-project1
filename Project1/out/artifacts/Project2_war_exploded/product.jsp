...
<div id="main_container">
    <div id="header">
        ...
        <div id="logo"> <a href="index.jsp"><img src="images/mainlogo.png" alt="" border="0" width="182" height="85" /></a> </div>
    </div>
    <div id="main_content">
        <div id="menu_tab">
            <ul class="menu">
        ...
        <div class="center_content">
            ...
            <sql:query dataSource="${snapshot}" var="result1">
                SELECT ptname from producttype where id = ${param.type};
            </sql:query>
            <c:forEach var="producttype" items="${result1.rows}" varStatus="status">
            <div class="center_title_bar">${producttype.ptname}</div>
            </c:forEach>
            <sql:query dataSource="${snapshot}" var="result2">
                SELECT * from product where typeid = ${param.type};
            </sql:query>
            <c:forEach var="product" items="${result2.rows}" varStatus="status">
                <div class="prod_box">
        ...
        <div class="right_content">
            ...
            <div class="border_box">
                <form method="get" action="searchProduct.jsp">
                    <input type="text" name="value" class="newsletter_input" />
